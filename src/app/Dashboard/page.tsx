...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setTotalProducts(productData.pagination.totalProducts);
    };
    fetchData();
  }, []);

  const handleCategoryClick = async (categoryId: string) => {
    const productsByCategory = await fetchProductbyCategoryId(categoryId);
  ...
  const handlePaginationChange = (currentPage: any) => {
    ...
    console.log("Please select SetCurrentPage by handlePaginationChange  ", currentPage);
  };
